...
public class Game extends Canvas implements KeyListener {
    ...
    public void initGame() {
        initMap();
        world.createActor(13, 4, tileSize, World.PLAYER);
    ...
    public void initMap() {//I can has tile map editor please?
        ...
        //world.setTile(11, 2, new Tile(tileSize));
        //world.setTile(11, 4, new Tile(tileSize));
        //world.setTile(10, 4, new Tile(tileSize));
        //world.setTile(11, 3, new Tile(tileSize));
        //Left wall
    ...
    public void drawWorld(Graphics2D g) {
        System.out.println("Main: Draw World!");
        world.draw(g);
    }
